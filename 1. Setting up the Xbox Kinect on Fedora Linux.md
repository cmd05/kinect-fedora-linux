...
This [instructable](https://www.instructables.com/Wiring-an-Xbox-Kinect-for-USB/) explains how to simply wire the Xbox Kinect from its custom adaptor to a USB adaptor. Note: Use only 12V or 2A.
...
The next part will include running a QT Application to interface with the kinect and do something interesting.